...
func NewProfileQ(db pgdb.DBTX) ProfileQ {
...
func (q ProfileQ) New() ProfileQ {
	return NewProfileQ(q.db)
}

func (q ProfileQ) Insert(ctx context.Context, data Profile) (Profile, error) {
...
func (q ProfileQ) Get(ctx context.Context) (Profile, error) {
...
func (q ProfileQ) Select(ctx context.Context) ([]Profile, error) {
...
func (q ProfileQ) Delete(ctx context.Context) error {
...
func (q ProfileQ) Count(ctx context.Context) (int64, error) {
...
func (q ProfileQ) UpdateOne(ctx context.Context) (Profile, error) {
...
func (q ProfileQ) UpdateMany(ctx context.Context) (int64, error) {
	q.updater = q.updater.Set("updated_at", time.Now().UTC())
...
func (q ProfileQ) FilterByAccountID(accountID uuid.UUID) ProfileQ {
...
func (q ProfileQ) FilterByUsername(username string) ProfileQ {
...
func (q ProfileQ) FilterOfficial(official bool) ProfileQ {
...
func (q ProfileQ) FilterLikeUsername(username string) ProfileQ {
...
func (q ProfileQ) FilterLikePseudonym(pseudonym string) ProfileQ {
...
func (q ProfileQ) UpdateUsername(username string) ProfileQ {
	q.updater = q.updater.Set("username", username)
	return q
}

func (q ProfileQ) UpdateOfficial(official bool) ProfileQ {
	q.updater = q.updater.Set("official", official)
	return q
}

func (q ProfileQ) UpdatePseudonym(pseudonym *string) ProfileQ {
	q.updater = q.updater.Set("pseudonym", pseudonym)
	return q
}

func (q ProfileQ) CursorCreatedAt(limit uint, asc bool, createdAt time.Time, accountID uuid.UUID) ProfileQ {
	if asc {
