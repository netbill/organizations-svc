...
func (q CitiesQ) OrderNearest(limit uint, lat, lng float64) CitiesQ {
...
func (q CitiesQ) FilterWithinRadiusMeters(lat, lng float64, radiusMeters float64) CitiesQ {
...
func (q CitiesQ) SelectNearest(ctx context.Context) ([]CityDistance, error) {
...
func (q CitiesQ) GetNearest(ctx context.Context) (CityDistance, error) {
